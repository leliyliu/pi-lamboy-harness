...
| 2026-08-14 | 学术包试用结论：pi-bib ✅ 保留（CrossRef/S2 双源校验精准，区分网络问题与虚构条目）；pi-critique ✅ 保留（学术 lens 8 条编号批评全部有据含改写方向）；academic-research-skills ✅ 保留（多视角评审 Reject 判定+证据行号+复现命令；CC-BY-NC 个人使用合规确认） | ✅ 已执行 |
